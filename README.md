<html>
  <body>
    <table width="100%">
      <tr>
        <td align="center">🎙️ <i>About the platform</i></td>
        <td></td>
      </tr>
      <tr>
        <td width="50%" valign="top">
          ...
          <p>
            ...
            long-form conversations with the people building it. New episodes drop on
            Spotify, and the conversation keeps going across the socials.
          </p>
        ...
        <td width="50%" valign="top">
          ...
          <p align="center">
            ✨ 🎧 ✨
            <br />
            <strong>Wherever you listen, we're on the line.</strong>
            <br />
            <br />
            <!-- Spotify -->
